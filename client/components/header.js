...
const Header = () => {
  return (
    <div className="grid grid-cols-5 bg-gray-600 py-8">
      <div
        id="BrandName"
        className="text-white text-center pt-1 text-3xl font-bold transition duration-300 ease-in-out hover:text-gray-700"
      >
