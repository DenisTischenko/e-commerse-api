  ...
  return (
    <div className="sort grid grid-cols-2">
      <div className="button_sort-price justify-self-end">
        <div className="mx-2 py-3 bg-gray-500 rounded-md w-32 text-white text-center  transition duration-300 ease-in-out hover:bg-gray-700 ">
          <button id="price" type="button" onClick={onClick('price')}>
            Sort by price
          </button>
        </div>
      </div>
      <div className="button_sort-name">
        <div className="mx-2 py-3 bg-gray-500 rounded-md w-32  text-white text-center transition duration-300 ease-in-out hover:bg-gray-700 ">
          <button id="name" type="button" onClick={onClick('by_name')}>
            Sort by name
          </button>
        </div>
      </div>
